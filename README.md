...
I'm a results-driven Web Developer specializing in **WordPress theme development** and **frontend technologies**. With a strong foundation in `HTML`, `CSS`, `JavaScript`, `PHP`, and `MySQL`, I craft responsive, dynamic websites with clean, maintainable code.

Currently pursuing a **B.Sc. in Computer Science & Engineering** from **National University, Bangladesh**, and working as a **Junior Web Developer (Part-Time)** at **ALOKIO**, where I collaborate on real client projects that improve user experience and functionality.
...
📍 ALOKIO · Oct 2025 – Present
Continuing on from a 4-month internship into a part-time contractual role, building and maintaining client websites with a focus on WordPress, responsive design, and dynamic content.

**🔹 WordPress Web Developer Intern**
📍 ALOKIO · May 2025 – Sep 2025
Worked on custom WordPress theme development, responsive design, and dynamic content integration using the WordPress Customizer and ACF.

---

### 📌 Featured Projects

Client and team projects I've contributed to at ALOKIO:

| Project | Link |
|---|---|
| Kloudify | [kloudify.com](https://kloudify.com/) |
| Activate Advocacy | [activateadvocacy.co](https://activateadvocacy.co/) |
| Dry Fish BD | [dryfish.bd](https://dryfish.bd/) |
| Bunon BD | [bunon.bd](https://bunon.bd) |
| TekHive | [tekhive.net](https://tekhive.net/) |
| Fresh Ready Thailand | [freshreadythailand.com](https://freshreadythailand.com/) |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Profile-6C63FF?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/pabitra-webdev)
[![Gmail](https://img.shields.io/badge/Email-Contact-00C6AE?style=for-the-badge&logo=gmail&logoColor=white)](mailto:aporoppabitra.ap@gmail.com)
